...
<head>
    ...
    <title>Edit Food Controller</title>
</head>
<?php
...
if(isset($_REQUEST['submit']))
{
    ...
    $result = $mydb->updateFoodController($conobj,"food_controller",$id,$name,$email,$password,$user_type,$phone);
    if($result){
...
<body>
    <?php
     ...
     $conobj= $mydb->OpenConn();
    $id = $_REQUEST['id'];
    $rows = mysqli_fetch_assoc(mysqli_query($conobj,"SELECT * FROM food_controller WHERE id = $id"))
     ?>
