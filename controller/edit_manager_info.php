...
if(isset($_REQUEST['submit']))
{
    ...
    $result = $mydb->updateManager($conobj,"manager",$id,$name,$email,$password,$user_type,$phone);
    if($result){
...
<body>
    <?php
     ...
     $conobj= $mydb->OpenConn();
    $id = $_REQUEST['id'];
    $rows = mysqli_fetch_assoc(mysqli_query($conobj,"SELECT * FROM manager WHERE id = $id"))
     ?>
    ...
    <div>
        ...
        <div class="center">
            <a class="common_btn" href="../view/admin_dashbord.php">Back Home</a>
        </div>
